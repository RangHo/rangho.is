...
const config = {
  ...
  preprocess: [
    orgPreprocess({
      ...
      latexDisplayFragmentFormat: "<Math expression={%s} displayMode inlineMode />",
      latexInlineFragmentFormat: "<Math expression={%s} inlineMode />",
      metadataExportList: ["title", "subtitle", "description", "date", "language"],
  ...
  kit: {
    ...
    prerender: { handleMissingId: "warn", handleUnseenRoutes: "warn" }
  }
};
